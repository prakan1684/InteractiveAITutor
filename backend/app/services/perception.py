...
def detect_regions(image_path:str, max_regions:int = 50) -> List[Region]:
    """
    Detects regions in the image
    """
    return []

def classify_regions(regions:List[Region]) -> List[Region]:
    """
    Classifies regions in the image
    """
    return []

def extract_expressions(image_path:str, regions:List[Region]) -> List[Expression]:
    """
...
def extract_steps(expressions:List[Expression], regions:List[Region]) -> List[Step]:
    """
...
def guess_problem_type(steps:List[Step], expressions:List[Expression]) -> Tuple[str, float]:
    """
